...
With your `.env` configured and your paths set up (refer to [`docs/03_configuration.md`](../docs/03_configuration.md) for `config.yaml` details), you are ready to boot the background services and build the sandbox.
